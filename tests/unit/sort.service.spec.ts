...
expect(SortUtils.bubbleSort(singleElementArray)).toEqual(singleElementArray);
    });

    it('deve ordenar um array com elementos duplicados', () => {
expect(SortUtils.bubbleSort(duplicatesArray)).toEqual(sortedDuplicatesArray);
    });
...
expect(SortUtils.mergeSort(emptyArray)).toEqual([]);
    ...
    it('deve lidar com um array de um único elemento', () => {
expect(SortUtils.mergeSort(singleElementArray)).toEqual(singleElementArray);
    });

    it('deve ordenar um array com elementos duplicados', () => {
expect(SortUtils.mergeSort(duplicatesArray)).toEqual(sortedDuplicatesArray);
    });
...
expect(SortUtils.quickSort(emptyArray)).toEqual([]);
    ...
    it('deve lidar com um array de um único elemento', () => {
expect(SortUtils.quickSort(singleElementArray)).toEqual(singleElementArray);
    });

    it('deve ordenar um array com elementos duplicados', () => {
expect(SortUtils.quickSort(duplicatesArray)).toEqual(sortedDuplicatesArray);
    });
...
expect(SortUtils.heapSort(emptyArray)).toEqual([]);
    ...
    it('deve lidar com um array de um único elemento', () => {
expect(SortUtils.heapSort(singleElementArray)).toEqual(singleElementArray);
    });

    it('deve ordenar um array com elementos duplicados', () => {
expect(SortUtils.heapSort(duplicatesArray)).toEqual(sortedDuplicatesArray);
    });
...
expect(SortUtils.selectionSort(emptyArray)).toEqual([]);
    ...
    it('deve lidar com um array de um único elemento', () => {
expect(SortUtils.selectionSort(singleElementArray)).toEqual(singleElementArray);
    });

    it('deve ordenar um array com elementos duplicados', () => {
expect(SortUtils.selectionSort(duplicatesArray)).toEqual(sortedDuplicatesArray);
    });

    it('deve ordenar um array com números negativos', () => {
expect(SortUtils.selectionSort(negativeArray)).toEqual(sortedNegativeArray);
    });
...
expect(SortUtils.insertionSort(emptyArray)).toEqual([]);
    ...
    it('deve lidar com um array de um único elemento', () => {
expect(SortUtils.insertionSort(singleElementArray)).toEqual(singleElementArray);
    });

    it('deve ordenar um array com elementos duplicados', () => {
expect(SortUtils.insertionSort(duplicatesArray)).toEqual(sortedDuplicatesArray);
    });

    it('deve ordenar um array com números negativos', () => {
expect(SortUtils.insertionSort(negativeArray)).toEqual(sortedNegativeArray);
    });
...
expect(SortUtils.shellSort(emptyArray)).toEqual([]);
    ...
    it('deve lidar com um array de um único elemento', () => {
expect(SortUtils.shellSort(singleElementArray)).toEqual(singleElementArray);
    });

    it('deve ordenar um array com elementos duplicados', () => {
expect(SortUtils.shellSort(duplicatesArray)).toEqual(sortedDuplicatesArray);
    });
...
expect(SortUtils.countingSort(unsortedPositive, 8)).toEqual(sortedPositive);
    });
...
expect(SortUtils.countingSort(unsortedDuplicates, 9)).toEqual(sortedDuplicates);
    });
...
expect(SortUtils.bucketSort(unsortedDuplicates)).toEqual(sortedDuplicates);
    });
