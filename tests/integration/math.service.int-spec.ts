...
describe('MathUtils - Testes de Integração', () => {
  describe('Cálculos financeiros', () => {
    it('deve calcular e arredondar porcentagens corretamente', () => {
      ...
      expect(porcentagemArredondada).toBeCloseTo(25.00);
    });
  });
  ...
  describe('Operações com frações', () => {
    ...
    it('deve calcular o denominador comum usando MMC', () => {
      ...
      const numerador1Ajustado = fracao1.numerador * (denominadorComum / fracao1.denominador);
      const numerador2Ajustado = fracao2.numerador * (denominadorComum / fracao2.denominador);
