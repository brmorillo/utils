...
describe('StringUtils - Testes de Benchmark', () => {
  ...
  describe('capitalizeFirstLetter', () => {
    it('deve processar 1.000.000 de strings em tempo razoável', () => {
      ...
      console.log(`Tempo para capitalizar ${count} strings: ${executionTime.toFixed(2)}ms`);
  ...
  describe('reverse', () => {
    it('deve processar 1.000.000 de strings em tempo razoável', () => {
      ...
      console.log(`Tempo para reverter ${count} strings: ${executionTime.toFixed(2)}ms`);
    ...
    it('deve processar 10.000 strings longas em tempo razoável', () => {
      ...
      console.log(`Tempo para reverter ${count} strings longas: ${executionTime.toFixed(2)}ms`);
  ...
  describe('isPalindrome', () => {
    it('deve processar 1.000.000 de verificações de palíndromo em tempo razoável', () => {
      ...
      console.log(`Tempo para verificar ${count} palíndromos: ${executionTime.toFixed(2)}ms`);
    ...
    it('deve processar 10.000 verificações de palíndromo com strings complexas em tempo razoável', () => {
      ...
      console.log(`Tempo para verificar ${count} palíndromos complexos: ${executionTime.toFixed(2)}ms`);
  ...
  describe('truncate', () => {
    it('deve processar 1.000.000 de truncamentos em tempo razoável', () => {
      ...
      console.log(`Tempo para truncar ${count} strings: ${executionTime.toFixed(2)}ms`);
  ...
  describe('toKebabCase', () => {
    it('deve processar 100.000 conversões para kebab-case em tempo razoável', () => {
      ...
      console.log(`Tempo para converter ${count} strings para kebab-case: ${executionTime.toFixed(2)}ms`);
  ...
  describe('toSnakeCase', () => {
    it('deve processar 100.000 conversões para snake_case em tempo razoável', () => {
      ...
      console.log(`Tempo para converter ${count} strings para snake_case: ${executionTime.toFixed(2)}ms`);
  ...
  describe('toCamelCase', () => {
    it('deve processar 100.000 conversões para camelCase em tempo razoável', () => {
      ...
      console.log(`Tempo para converter ${count} strings para camelCase: ${executionTime.toFixed(2)}ms`);
  ...
  describe('toTitleCase', () => {
    it('deve processar 100.000 conversões para title case em tempo razoável', () => {
      ...
      console.log(`Tempo para converter ${count} strings para title case: ${executionTime.toFixed(2)}ms`);
  ...
  describe('countOccurrences', () => {
    it('deve processar 100.000 contagens de ocorrências em tempo razoável', () => {
      const input = 'This is a string with multiple occurrences of the word string. String appears multiple times in this string.';
      ...
      console.log(`Tempo para contar ${count} ocorrências: ${executionTime.toFixed(2)}ms`);
    ...
    it('deve processar 10.000 contagens de ocorrências em strings longas em tempo razoável', () => {
      ...
      console.log(`Tempo para contar ${count} ocorrências em strings longas: ${executionTime.toFixed(2)}ms`);
  ...
  describe('replaceAll', () => {
    it('deve processar 100.000 substituições em tempo razoável', () => {
      ...
      console.log(`Tempo para realizar ${count} substituições: ${executionTime.toFixed(2)}ms`);
  ...
  describe('replaceOccurrences', () => {
    it('deve processar 100.000 substituições de ocorrências em tempo razoável', () => {
      ...
      const executionTime = measureExecutionTime(() => {
        for (let i = 0; i < count; i++) {
          StringUtils.replaceOccurrences({ input, substring, replacement, occurrences });
        }
      });
      
      console.log(`Tempo para realizar ${count} substituições de ocorrências: ${executionTime.toFixed(2)}ms`);
  ...
  describe('replacePlaceholders', () => {
    it('deve processar 100.000 substituições de placeholders em tempo razoável', () => {
      const template = 'Hello, {name}! You have {count} new messages. Your last login was on {date}.';
      ...
      console.log(`Tempo para realizar ${count} substituições de placeholders: ${executionTime.toFixed(2)}ms`);
    ...
    it('deve processar 10.000 substituições de placeholders em templates longos em tempo razoável', () => {
      ...
      console.log(`Tempo para realizar ${count} substituições de placeholders em templates longos: ${executionTime.toFixed(2)}ms`);
    ...
    it('deve processar 10.000 operações combinadas em tempo razoável', () => {
      ...
      const executionTime = measureExecutionTime(() => {
        for (let i = 0; i < count; i++) {
          ...
          const truncated = StringUtils.truncate({ input: reversed, maxLength: 20 });
          const titleCase = StringUtils.toTitleCase({ input: truncated });
        }
      });
      
      console.log(`Tempo para realizar ${count} operações combinadas: ${executionTime.toFixed(2)}ms`);
